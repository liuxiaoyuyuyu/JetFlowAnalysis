...
const int   trackbinbounds[trackbin]         = {0,25,36,48,60,71,78,91,97};
const int   trackbinboundsUpper[trackbin]    = {25,36,48,60,71,78,91,97,mm};

//const int   trackbinbounds[trackbin]         = {76,78,80,81,82};
//const int   trackbinboundsUpper[trackbin]    = {mm,mm,mm,mm,mm};
//const float pt_T_lo[ptbin_T]       = {0.3,1.0,0.3};
//const float pt_T_hi[ptbin_T]       = {1.0,3.0,3.0};
//const float pt_A_lo[ptbin_A]={0.3};
//const float pt_A_hi[ptbin_A]={3.0};

const float pt_T_lo[ptbin_T]       = {0.0,0.3,0.7,1.3,2.0,0.3,0.0};
const float pt_T_hi[ptbin_T]       = {0.3,0.7,1.3,2.0,3.0,3.0,3.0};
const float pt_A_lo[ptbin_A]={0.3,0.0};
const float pt_A_hi[ptbin_A]={3.0,3.0};
