                            ...
                            for(    int j = 0; j < ptbin;    j++){
                                if(tkBool[i] + A_ptBool[A_trk][j] + A_ptBool[T_trk][j] == 3){
                                    ...
                                    */
                                    ...
                                    double EEC_weight = jet_dau_pt * T_jet_dau_pt;
                                    if(EEC_weight > 1e-6){  
                                        hSignalShiftedUnc[i][j][k_PU]->Fill(deltaEta, deltaPhi,                   EEC_weight*jet_HLT_weight/(Ntrig[i][j] ));
                                        hSignalShiftedUnc[i][j][k_PU]->Fill(-deltaEta, deltaPhi,                  EEC_weight*jet_HLT_weight/(Ntrig[i][j] ));
                                        hSignalShiftedUnc[i][j][k_PU]->Fill(deltaEta, -deltaPhi,                  EEC_weight*jet_HLT_weight/(Ntrig[i][j] ));
                                        hSignalShiftedUnc[i][j][k_PU]->Fill(-deltaEta, -deltaPhi,                 EEC_weight*jet_HLT_weight/(Ntrig[i][j] ));
                                        hSignalShiftedUnc[i][j][k_PU]->Fill( deltaEta,2*TMath::Pi() - deltaPhi,   EEC_weight*jet_HLT_weight/(Ntrig[i][j] ));
                                        hSignalShiftedUnc[i][j][k_PU]->Fill(-deltaEta,2*TMath::Pi() - deltaPhi,   EEC_weight*jet_HLT_weight/(Ntrig[i][j] ));
                                        
                                        hSignalShiftedCor[i][j][k_PU]->Fill(deltaEta, deltaPhi,                   EEC_weight*jet_HLT_weight/(Atrk_weight * Ttrk_weight * NtrigCorrected[i][j] ));
                                        hSignalShiftedCor[i][j][k_PU]->Fill(-deltaEta, deltaPhi,                  EEC_weight*jet_HLT_weight/(Atrk_weight * Ttrk_weight * NtrigCorrected[i][j] ));
                                        hSignalShiftedCor[i][j][k_PU]->Fill(deltaEta, -deltaPhi,                  EEC_weight*jet_HLT_weight/(Atrk_weight * Ttrk_weight * NtrigCorrected[i][j] ));
                                        hSignalShiftedCor[i][j][k_PU]->Fill(-deltaEta, -deltaPhi,                 EEC_weight*jet_HLT_weight/(Atrk_weight * Ttrk_weight * NtrigCorrected[i][j] ));
