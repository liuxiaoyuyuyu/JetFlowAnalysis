...
void MyClass::Loop(int job, std::string fList){
    ...
    #ifdef _jetaxissmear
    TFile* fS_tempA = new TFile(Form("/eos/cms/store/group/phys_heavyions/xiaoyul/Run2_root_out/jTDiff/syscheck/jetaxis/job_newNch78_%s.root",subList.c_str()), "recreate");
    #endif
    #ifdef _jetptsmear
